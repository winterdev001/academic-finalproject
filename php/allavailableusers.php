    ...
    <div class="content  ">
		...
		<div ng-app='index' ng-controller='indexCtrl' >
            ...
            <div class="col-lg-12 ">
		     <!-- all users -->
        <!-- table -->
<h3 class="hd text-warning"><span class="use-link1"><a href="allusers.php">All Users</a></span><span class="use-link2"><a class="active" href="allavailableusers.php">Available Users</a></span><span class="use-link3"><a href="allhiredusers.php">Hired Users</a></span></h3>
<h3 style="font-size:25px;"><a href="../adminto/dark_menu/fpdf181/availablepdf.php">View & Download Report</a></h3>
  ...
  <tbody>
    ...
    while ($row = $result-> fetch_assoc()) {
        ...
        <tr>
            ...
            <td><?php echo "<b><a href='allavailableusers.php?updat={$row['ID']}'>hire</a></b>'"; ?></td>
            <td><?php echo "<b><a href='allavailableusers.php?del={$row['ID']}'>delete</a></b>'"; ?></td>

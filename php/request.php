    ...
    <div class="content  ">
		...
		<div ng-app='index' ng-controller='indexCtrl' >
            ...
            <div class="col-lg-12 ">
		     <!-- all users -->
        <!-- table -->
<h3 class="hd text-warning"><span class="use-link1"><span class="active">Requests</span></span> <a  href="requestreport.php">Report</a></h3>
  ...
  <tbody>
    ...
    while ($row = $result-> fetch_assoc()) {
        ...
        <tr>
            ...
            <td><?php echo "<b><a href='request.php?del={$row['id']}'>delete</a></b>'"; ?></td>
